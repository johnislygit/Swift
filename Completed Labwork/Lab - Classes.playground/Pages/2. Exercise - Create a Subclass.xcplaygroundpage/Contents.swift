 ...
 */
//print(falcon.weapon) //Weapon was defined in the inherited class so it doesn't apply for the base class. Since it doesn't go up the tree weapon in invalid.
